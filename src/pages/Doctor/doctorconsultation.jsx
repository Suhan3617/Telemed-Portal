...
import { MessageSquare, ClipboardList, NotebookText, HeartPulse } from 'lucide-react';
...
  const [notesContent, setNotesContent] = useState('Patient confirms worsening rash on extremities. Subjective: Itching level 7/10. Objective: Rash is erythematous and vesicular. Plan: Review recent labs and adjust anti-histamine dosage.');
...
    { label: 'Blood Pressure', value: latestVitals.bp, trend: 'Slightly High', unit: 'mmHg', data: [118, 122, 128, 130, 128] },
    { label: 'Heart Rate', value: `${latestVitals.hr} bpm`, trend: 'Stable', unit: 'bpm', data: [70, 75, 74, 71, 74] },
    { label: 'SpO2', value: `${latestVitals.spo2}%`, trend: 'Good', unit: '%', data: [97, 98, 98, 99, 98] },
  ] : [];
...
        className="text-3xl font-extrabold text-blue-800 mb-8 tracking-tight"
      >
        TeleConsultation Live Session
      </motion.header>

      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-8">
          <VideoPlaceholder patientName={PATIENT_DATA_RAW.name || 'Loading...'} />
          <PatientInfoCard summaryData={{
