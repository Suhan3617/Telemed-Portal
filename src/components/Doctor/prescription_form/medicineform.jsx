  ...
  return (
    <div className="space-y-4">
      ...
      {medicines.map((med, index) => (
        <motion.div
          key={index}
          className="grid grid-cols-2 md:grid-cols-7 gap-3 items-center p-4 rounded-3xl shadow-lg bg-gradient-to-r from-blue-50 via-blue-100 to-blue-200 border border-blue-300 hover:shadow-2xl transition-all"
        ...
        >
          ...
          <select
            ...
            className="border border-blue-300 rounded-2xl p-3 focus:ring-2 focus:ring-blue-400 transition-all hover:shadow-lg"
          >
