...
const videoplaceholder = ({ patientName }) => {
  return (
    ...
    className="relative w-full aspect-[16/9] bg-gray-900 rounded-3xl shadow-2xl overflow-hidden
               border-4 border-blue-500 transition-all duration-700"
    style={{
  ...
  >
    ...
    {/* Patient Name Tag (Small PIP style) */}
